# Legacy Package Changelog

> These entries describe development before the independent `io.github.samson910022.pixelifyphotos` package and are retained only for historical context. They are not releases of the independent package.
